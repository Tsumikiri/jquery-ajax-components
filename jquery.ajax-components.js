...
(function($) {
	 ...
	 * });
	 *
	 * @example <caption>An alternative for using the deferred object by instead using the <code>error</code> parameter of <code>jQuery.ajax</code>.</caption>
	 * $('#my-form').ac('submit', {
	 ...
	 * @description This is a wrapper for <code>jQuery.ajax</code> that includes the response handler functionality of the Ajax Components plugin. Access to this function is provided so that the plugin's response handler functionality can be used outside of an actual component element.
	 *
	 * @example <caption>Calling the static <code>ac</code> function as you would call {@link http://api.jquery.com/jquery.ajax/|jQuery.ajax}.</caption>
	 * $.ac({
	 *     url: '/path/to/remote/function/',
	 *     method: 'post',
	 *     data: {
	 ...
	 * @returns {jqXHR} The jqXHR object generated by {@link http://api.jquery.com/jquery.ajax/|jQuery.ajax}; like a promise
	 */
	$.ac = ajaxWrapper;
	 ...
	 * @property {AjaxOptions} ajaxDefaults - The default values to use for ajax options to be passed to <code>jQuery.ajax</code>.
